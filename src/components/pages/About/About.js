  ...
  return (
    <Layout>
      <div className={styles.content}>
        ...
        <p>
          Take CMD was inspired by the article <Link className={styles.link} to='https: //alistapart.com/article/the-career-management-document/'> The Career Management Document</Link>. 
